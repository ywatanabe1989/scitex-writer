...
%DIF DEL /home/ywatanabe/.cache/tmp/tmp.vgRXhzLBLT.tex   Wed Feb 18 21:02:10 2026
%DIF ADD ./01_manuscript/manuscript.tex                  Wed Feb 18 21:01:57 2026
%DIF 2c2
%DIF < % SciTeX Writer 2.6.3 (https://scitex.ai)
%DIF -------
% SciTeX Writer 2.6.7 (https://scitex.ai) %DIF > 
%DIF -------
% LaTeX compilation engine: auto
%DIF 4c4
%DIF < % Compiled: 2026-02-11 18:23:39
%DIF -------
% Compiled: 2026-02-18 21:01:57 %DIF > 
%DIF -------
...
%% -*- coding: utf-8 -*-
%DIF 9-10c9
%DIF < %% Timestamp: "2025-09-27 22:21:42 (ywatanabe)"
%DIF < %% File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/01_manuscript/base.tex"
%DIF -------
%% File: 01_manuscript/base.tex %DIF > 
%DIF -------
\UseRawInputEncoding
...
%DIF 226c225
%DIF < \definecolor{MonacoFg}{HTML}{F0F0F0}
%DIF -------
\definecolor{MonacoFg}{HTML}{D4D4D4} %DIF > 
%DIF -------
\pagecolor{MonacoBg}
\color{MonacoFg}
...
%% =============================================================================
%% Comparison: v513391d → v721a65c+
%% Generated: 2026-02-18 21:02:11
...
\fancypagestyle{diffstyle}{
    ...
    \fancyhead[L]{\small\textit{Diff: v513391d → v721a65c+}}
    \fancyhead[R]{\small\textit{manuscript}}
    \fancyfoot[L]{\small Generated: 2026-02-18 21:02}
...
% ======================================================================
\DIFdelbegin %DIFDELCMD < \pdfbookmark[2]{Table 1_example_table}{table_01_example_table}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \pdfbookmark[2]{Table 01 --- Replace with your table title}{table_01_example_table}
...
% Figure 01
\begin{figure*}[htbp]
    \DIFdelbeginFL %DIFDELCMD < \pdfbookmark[2]{Figure 01}{.01}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \pdfbookmark[2]{Figure 01 --- Replace with your figure title}{.01}
...
% Figure 02
\begin{figure*}[htbp]
    \DIFdelbeginFL %DIFDELCMD < \pdfbookmark[2]{Figure 02}{.02}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \pdfbookmark[2]{Figure 02 --- Replace with your figure title}{.02}
    \DIFaddendFL \centering
