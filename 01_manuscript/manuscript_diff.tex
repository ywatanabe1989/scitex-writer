...
%DIF DEL /home/ywatanabe/.cache/tmp/tmp.Rwm8gffhEK.tex   Wed Feb 11 18:23:51 2026
%DIF ADD ./01_manuscript/manuscript.tex                  Wed Feb 11 18:23:39 2026
%DIF 2c2
%DIF < % SciTeX Writer 2.5.0 (https://scitex.ai)
%DIF -------
% SciTeX Writer 2.6.3 (https://scitex.ai) %DIF > 
%DIF -------
% LaTeX compilation engine: auto
%DIF 4c4
%DIF < % Compiled: 2026-02-04 09:50:17
%DIF -------
% Compiled: 2026-02-11 18:23:39 %DIF > 
%DIF -------
...
%DIF < %% File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/00_shared/latex_styles/columns.tex"
%DIF -------
...
%DIF < %% File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/00_shared/latex_styles/packages.tex"
%DIF -------
...
%DIF < %% File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/00_shared/latex_styles/linker.tex"
%DIF -------
...
%DIF < %% File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/00_shared/latex_styles/formatting.tex"
%DIF -------
...
%% =============================================================================
%% Comparison: v0db5c20 → v4de1e3f+
%% Generated: 2026-02-11 18:23:53
...
\fancypagestyle{diffstyle}{
    ...
    \fancyhead[L]{\small\textit{Diff: v0db5c20 → v4de1e3f+}}
    \fancyhead[R]{\small\textit{manuscript}}
    \fancyfoot[L]{\small Generated: 2026-02-11 18:23}
...
% ======================================================================
%% -*- coding: utf-8 -*-
%DIF < % Timestamp: "2025-09-28 20:27:49 (ywatanabe)"
...
\title{
\DIFdelbegin \DIFdel{SciTeX Writer: Modular Framework for Version-Controlled Manuscripts, Supplementary Materials, and Peer Review Responses
}\DIFdelend \DIFaddbegin \DIFadd{Your Manuscript Title Here
}\DIFaddend }
...
% ======================================================================
%% -*- coding: utf-8 -*-
\author[1]{\DIFdelbegin \DIFdel{Yusuke Watanabe}\DIFdelend \DIFaddbegin \DIFadd{First Author}\DIFaddend \corref{cor1}}
\author[2]{Second Author}
\author[3]{Third Author}

\DIFdelbegin %DIFDELCMD < \address[1]{SciTeX.ai, Tokyo, Japan}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \address[1]{First Institution, Department, City, Country}
\DIFaddend \address[2]{Second Institution, Department, City, Country}
\address[3]{Third Institution, Department, City, Country}

\DIFdelbegin %DIFDELCMD < \cortext[cor1]{Corresponding author. Email: ywatanabe@scitex.ai}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \cortext[cor1]{Corresponding author. Email: your.email@institution.edu}
\DIFaddend 
...
%DIFDELCMD < %%%
\subsection{\DIFdel{Automated Asset Processing}}
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{The system implements automatic format conversion for both figures and tables through preprocessing scripts that execute during compilation~\cite{Chen2021_MachineLearning}. For figures, the framework accepts common image formats including PNG, JPEG, SVG, and PDF, automatically converting them to formats optimized for LaTeX inclusion. Each figure resides in its own subdirectory within }\texttt{\DIFdel{01\_manuscript/contents/figures/caption\_and\_media/}}%DIFAUXCMD
\DIFdel{, with the caption defined in a corresponding }\texttt{\DIFdel{.tex}} %DIFAUXCMD
\DIFdel{file. During compilation, a preprocessing script scans these directories, generates figure inclusion code, and compiles all figures into }\texttt{\DIFdel{FINAL.tex}} %DIFAUXCMD
\DIFdel{for inclusion in the main document. Tables follow an analogous structure, allowing authors to define complex table layouts separately from their incorporation into the document flow~\cite{Brown2018_DeepLearning}.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Version Control and Difference Tracking}}
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{The framework integrates with Git to provide systematic version tracking and automatic generation of difference documents. When authors create a new version through }\texttt{\DIFdel{make archive}}%DIFAUXCMD
\DIFdel{, the system archives the current manuscript with a timestamp and version number. Subsequently, invoking }\texttt{\DIFdel{make diff}} %DIFAUXCMD
\DIFdel{generates a PDF highlighting changes between versions using the latexdiff utility. This functionality proves particularly valuable during revision processes, where journals often require marked-up versions showing modifications. The revision directory structure accommodates multiple rounds of review, with separate subdirectories for editor and reviewer responses, each containing both the original comments and author responses in a structured format that ensures complete documentation of the revision process.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Manuscript Preparation}}
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{This manuscript was prepared using SciTeX Writer~\cite{watanabe2025scitex}, an open-source scientific manuscript compilation system supporting multiple LaTeX compilation engines including latexmk, traditional 3-pass compilation, and Tectonic}\DIFdelend \DIFaddbegin \DIFadd{Replace this with your methods. Describe study design, data collection, and analysis procedures \cite{example_method_2019}. Provide enough detail for reproducibility}\DIFaddend .
...
%DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/00_shared/latex_styles/bibliography.tex"
...
% ======================================================================
%% -*- coding: utf-8 -*-
%DIF < % Timestamp: "2025-11-12 14:31:55 (ywatanabe)"
%DIF < % File: "/home/ywatanabe/proj/scitex-writer/01_manuscript/contents/data_availability.tex"
\pdfbookmark[1]{Data Availability Statement}{data_availability}

\section*{Data Availability Statement}

The \DIFdelbegin \DIFdel{SciTeX Writer is available at }%DIFDELCMD < \url{https://github.com/ywatanabe1989/scitex-python/tree/main/src/scitex/writer}%%%
\DIFdel{.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{For questions regarding data access or analysis procedures, please contact }\DIFdelend \DIFaddbegin \DIFadd{data and code that support the findings of this study are available from }\DIFaddend the corresponding author \DIFaddbegin \DIFadd{upon reasonable request}\DIFaddend .
...
% ======================================================================
%% -*- coding: utf-8 -*-
%DIF < % Timestamp: "2026-01-19 02:31:14 (ywatanabe)"
%DIF < % File: "/home/ywatanabe/proj/scitex-writer/01_manuscript/contents/additional_info.tex"

\pdfbookmark[1]{Additional Information}{additional_information}

\pdfbookmark[2]{Ethics Declarations}{ethics_declarations}
\section*{Ethics Declarations}
\DIFdelbegin \DIFdel{All study participants provided their written informed consent ..}\DIFdelend \DIFaddbegin \DIFadd{Replace with your ethics statement}\DIFaddend .
\label{ethics declarations}

\pdfbookmark[2]{Contributors}{author_contributions}
\section*{Author Contributions}
\DIFdelbegin \DIFdel{Y.W., T.Y., and D.G. conceptualized the study ..}\DIFdelend \DIFaddbegin \DIFadd{Replace with author contributions}\DIFaddend .
\label{author contributions}

\pdfbookmark[2]{Acknowledgments}{acknowledgments}
\section*{Acknowledgments}
\DIFdelbegin \DIFdel{This research was funded by ..}\DIFdelend \DIFaddbegin \DIFadd{Replace with acknowledgments}\DIFaddend .
...
\DIFdelbegin \DIFdel{The authors employed large language models such as Claude (Anthropic Inc.) for code development and complementing manuscript's English language quality. After incorporating suggested improvements, the authors meticulously revised the content. Ultimate responsibility for the final content of this publication rests entirely with the authors}\DIFdelend \DIFaddbegin \DIFadd{Disclose any use of generative AI tools here}\DIFaddend .
...
\DIFdelendFL \DIFaddbeginFL \begin{figure*}[htbp]
    ...
    \caption{\DIFdelbeginFL \DIFdelFL{Example figure caption. This is a template showing how to include figures in your manuscript. }\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Replace with your figure title.}}\\
\smallskip
\DIFaddendFL Replace \DIFdelbeginFL \DIFdelFL{this text }\DIFdelendFL with \DIFdelbeginFL \DIFdelFL{a descriptive caption that explains what the figure shows. Include panel labels (A, B, C) if using multipanel figures. Explain abbreviations and symbols used in the figure. Provide sufficient detail that readers can understand the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{your }\DIFaddendFL figure \DIFdelbeginFL \DIFdelFL{without referring to the main }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{legend }\DIFaddendFL text. \DIFaddbeginFL \DIFaddFL{Edit this caption at }\texttt{\DIFaddFL{01\_manuscript/contents/figures/caption\_and\_media/01\_example\_figure.tex}}\DIFaddFL{.
}\DIFaddendFL }
\DIFdelbeginFL %DIFDELCMD < \label{fig:example_figure_01}
%DIFDELCMD <     %%%
\DIFdelendFL \label{fig:01_example_figure}
\end{figure*}
...
\begin{figure*}[htbp]
    ...
    \caption{\DIFdelbeginFL \DIFdelFL{Another example figure. Use this template to add additional figures to }\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Replace with your figure title.}}\\
\smallskip
\DIFaddFL{Replace with }\DIFaddendFL your \DIFdelbeginFL \DIFdelFL{manuscript. Each }\DIFdelendFL figure \DIFdelbeginFL \DIFdelFL{should be placed in a separate }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{legend text}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{tex file in }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Edit }\DIFaddendFL this \DIFdelbeginFL \DIFdelFL{directory. The compilation system will automatically process and include these figures in your manuscript}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{caption at }\texttt{\DIFaddFL{01\_manuscript/contents/figures/caption\_and\_media/02\_another\_example.tex}}\DIFaddendFL .
}
\DIFdelbeginFL %DIFDELCMD < \label{fig:example_figure_02}
%DIFDELCMD <     %%%
