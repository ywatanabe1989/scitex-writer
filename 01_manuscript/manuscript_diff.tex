...
%DIF DEL ./01_manuscript/archive/manuscript_v039_diff.tex   Mon Nov 10 02:22:05 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Mon Nov 10 02:29:29 2025
%DIF 2-14d2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v038_diff.tex   Mon Nov 10 02:20:33 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Mon Nov 10 02:21:57 2025
%DIF < %DIF 2-9d2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v037_diff.tex   Mon Nov 10 02:16:53 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Mon Nov 10 02:20:26 2025
%DIF < %DIF < %DIF 2-4d2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Mon Nov 10 02:16:44 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Mon Nov 10 02:16:44 2025
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
%DIF -------
...
The preparation of scientific manuscripts involves numerous technical challenges that extend beyond the intellectual task of communicating research findings~\citep{Anderson2017_ReviewNeuroscience}. Researchers must navigate complex typesetting systems, manage multiple document versions, coordinate figures and tables across formats, and ensure reproducible compilation environments~\citep{Wilson2015_Neuroscience}. These technical burdens can distract from the primary goal of clear scientific communication and often lead to inconsistencies, formatting errors, and wasted time troubleshooting environment-specific compilation issues.

Traditional approaches to manuscript preparation typically rely on local LaTeX installations, where the specific versions of packages and compilation tools can vary significantly across different machines and over time~\citep{Lee2016_BrainNetworks}. This variability creates reproducibility challenges, particularly in collaborative environments where multiple authors work on different systems~\citep{Garcia2019_CognitiveNeuroscience}. Furthermore, the proliferation of image formats and the need to convert between them for different submission requirements adds another layer of complexity. Researchers often resort to ad-hoc scripts or manual processes to handle these conversions, leading to potential errors and inconsistent results.

Existing solutions have addressed some aspects of this problem~\citep{Thompson2018_SystemsNeuroscience}. Overleaf and similar cloud-based platforms provide consistent compilation environments but require continuous internet connectivity and may not suit all research workflows. Version control systems like Git effectively track changes but require researchers to understand both LaTeX and version control simultaneously. Template repositories exist for various journals, but they typically focus on formatting requirements rather than workflow automation and often duplicate common elements across documents.
