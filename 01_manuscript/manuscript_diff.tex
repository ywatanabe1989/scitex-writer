...
%DIF DEL ./01_manuscript/archive/manuscript_v001_diff.tex   Sat Jan 10 00:35:58 2026
%DIF ADD ./01_manuscript/manuscript.tex                     Mon Jan 19 02:33:27 2026
%DIF 2-4d2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/manuscript.tex   Sat Jan 10 00:35:46 2026
%DIF < %DIF ADD ./01_manuscript/manuscript.tex   Sat Jan 10 00:35:46 2026
%DIF -------
% SciTeX Writer v2.0.0-rc5 (https://scitex.ai)
% LaTeX compilation engine: auto
%DIF 7c4
%DIF < % Compiled: 2026-01-10 00:35:46
%DIF -------
% Compiled: 2026-01-19 02:33:27 %DIF > 
%DIF -------
...
%DIF < %% =============================================================================
%DIF < %% Comparison: vunknown → v0
%DIF < %% Generated: 2026-01-10 00:35:51
%DIF < %% User: Yusuke Watanabe <ywatanabe@scitex.ai>
%DIF < %% Document: manuscript
%DIF < %% Git commit: 0638a04
...
%DIF <     \fancyhead[L]{\small\textit{Diff: vunknown → v0}}
%DIF <     \fancyhead[R]{\small\textit{manuscript}}
%DIF <     \fancyfoot[L]{\small Generated: 2026-01-10 00:35}
...
\fancypagestyle{diffstyle}{
    ...
    \fancyfoot[L]{\small Generated: 2026-01-19 02:33}
...
This research was funded by \DIFdelbegin %DIFDELCMD < \hl{funding bodies here}
%DIFDELCMD < %%%
...
\begin{figure*}[h!]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/01.jpg}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/01_example_figure.jpg}
    \DIFaddendFL \caption{Example figure caption. This is a template showing how to include figures in your manuscript. Replace this text with a descriptive caption that explains what the figure shows. Include panel labels (A, B, C) if using multipanel figures. Explain abbreviations and symbols used in the figure. Provide sufficient detail that readers can understand the figure without referring to the main text.}
...
\begin{figure*}[htbp]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/02.jpg}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/02_another_example.jpg}
    \DIFaddendFL \caption{Another example figure. Use this template to add additional figures to your manuscript. Each figure should be placed in a separate .tex file in this directory. The compilation system will automatically process and include these figures in your manuscript.}
