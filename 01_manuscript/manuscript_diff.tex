...
%DIF DEL /home/ywatanabe/.cache/tmp/tmp.rqgog66KJ9.tex   Mon Feb  9 06:52:18 2026
%DIF ADD ./01_manuscript/manuscript.tex                  Mon Feb  9 06:52:03 2026
%DIF 2c2
%DIF < % SciTeX Writer v2.0.0-rc5 (https://scitex.ai)
%DIF -------
% SciTeX Writer 2.5.3 (https://scitex.ai) %DIF > 
%DIF -------
% LaTeX compilation engine: auto
%DIF 4c4
%DIF < % Compiled: 2026-01-19 04:07:07
%DIF -------
% Compiled: 2026-02-09 06:52:03 %DIF > 
%DIF -------
...
%% =============================================================================
%% Comparison: v7ea7ee9 → vff2094e+
%% Generated: 2026-02-09 06:52:20
...
\fancypagestyle{diffstyle}{
    ...
    \fancyhead[L]{\small\textit{Diff: v7ea7ee9 → vff2094e+}}
    \fancyhead[R]{\small\textit{manuscript}}
    \fancyfoot[L]{\small Generated: 2026-02-09 06:52}
...
The \DIFdelbegin \DIFdel{SciTeX Writer is available at }%DIFDELCMD < \url{https://github.com/ywatanabe1989/scitex-code/tree/main/src/scitex/writer}%%%
\DIFdel{.
}%DIFDELCMD < 
...
\begin{figure*}[h!]
    ...
    \caption{\DIFdelbeginFL \DIFdelFL{Example figure caption. This is a template showing how to include figures in your manuscript. }\DIFdelendFL Replace \DIFdelbeginFL \DIFdelFL{this text }\DIFdelendFL with \DIFdelbeginFL \DIFdelFL{a descriptive caption that explains what the figure shows. Include panel labels (A, B, C) if using multipanel figures. Explain abbreviations and symbols used in the figure. Provide sufficient detail that readers can understand the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{your }\DIFaddendFL figure \DIFdelbeginFL \DIFdelFL{without referring to the main text}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{caption}\DIFaddendFL .}
\DIFdelbeginFL %DIFDELCMD < \label{fig:example_figure_01}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:01_example_figure}
    \DIFaddendFL \label{fig:01_example_figure}
\end{figure*}
...
\begin{figure*}[htbp]
    ...
    \caption{\DIFdelbeginFL \DIFdelFL{Another example figure. Use this template to add additional figures to }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Replace with }\DIFaddendFL your \DIFdelbeginFL \DIFdelFL{manuscript. Each }\DIFdelendFL figure \DIFdelbeginFL \DIFdelFL{should be placed in a separate .tex file in this directory. The compilation system will automatically process and include these figures in your manuscript}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{caption}\DIFaddendFL .}
\DIFdelbeginFL %DIFDELCMD < \label{fig:example_figure_02}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:02_another_example}
    \DIFaddendFL \label{fig:02_another_example}
\end{figure*}
