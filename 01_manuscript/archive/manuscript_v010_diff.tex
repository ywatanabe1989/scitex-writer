...
%DIF DEL ./01_manuscript/archive/manuscript_v009_diff.tex   Tue Sep 30 18:02:27 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:02:52 2025
%DIF 2-44d2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v008_diff.tex   Tue Sep 30 18:01:46 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:02:11 2025
%DIF < %DIF 2-39d2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v007_diff.tex   Tue Sep 30 18:01:05 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:01:30 2025
%DIF < %DIF < %DIF 2-34d2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v006_diff.tex   Tue Sep 30 18:00:25 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:00:49 2025
%DIF < %DIF < %DIF < %DIF 2-29d2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v005_diff.tex   Tue Sep 30 17:59:44 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:00:09 2025
%DIF < %DIF < %DIF < %DIF < %DIF 2-24d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v004_diff.tex   Tue Sep 30 17:59:03 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:59:29 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-19d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v003_diff.tex   Tue Sep 30 17:58:20 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:58:46 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-14d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Tue Sep 30 17:41:53 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:58:01 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-9d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v001_diff.tex   Tue Sep 30 09:26:46 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:41:35 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-4d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Tue Sep 30 09:26:29 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Tue Sep 30 09:26:29 2025
...
%DIF 79-107c36
%DIF < %DIF 74-98c36
%DIF < %DIF < %DIF 69-89c36
%DIF < %DIF < %DIF < %DIF 64-80c36
%DIF < %DIF < %DIF < %DIF < %DIF 59-71c36
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 54-62c36
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 49-53c36
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 44c36
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-27 16:01:16 (ywatanabe)"
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 109-142c38-39
%DIF < %DIF 100-128c38-39
%DIF < %DIF < %DIF 91-114c38-39
%DIF < %DIF < %DIF < %DIF 82-100c38-39
%DIF < %DIF < %DIF < %DIF < %DIF 73-86c38-39
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 64-72c38-39
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 55-58c38-39
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 46a38-39
...
%DIF 150-179c47
%DIF < %DIF 136-161c47
%DIF < %DIF < %DIF 122-143c47
%DIF < %DIF < %DIF < %DIF 108-125c47
%DIF < %DIF < %DIF < %DIF < %DIF 94-107c47
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 80-89c47
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 66-71c47
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 53-54c47
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{amsmath, amssymb}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{amsthm}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 186-215c54
%DIF < %DIF 168-193c54
%DIF < %DIF < %DIF 150-171c54
%DIF < %DIF < %DIF < %DIF 132-149c54
%DIF < %DIF < %DIF < %DIF < %DIF 114-127c54
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 96-105c54
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 78-83c54
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 61-62c54
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{pgfplots}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{pgfplotstable}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 220-262c59-60
%DIF < %DIF 198-235c59-60
%DIF < %DIF < %DIF 176-208c59-60
%DIF < %DIF < %DIF < %DIF 154-181c59-60
%DIF < %DIF < %DIF < %DIF < %DIF 132-154c59-60
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 110-127c59-60
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 88-100c59-60
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 67-74c59-60
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{booktabs}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{colortbl}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{longtable}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{supertabular}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{tabularx}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{xltabular}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{csvsimple}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{makecell}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 273-303c71
%DIF < %DIF 246-272c71
%DIF < %DIF < %DIF 219-241c71
%DIF < %DIF < %DIF < %DIF 192-210c71
%DIF < %DIF < %DIF < %DIF < %DIF 165-179c71
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 138-148c71
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 111-117c71
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 85-87c71
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{pdflscape}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{indentfirst}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{calc}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 311-342c79
%DIF < %DIF 280-307c79
%DIF < %DIF < %DIF 249-272c79
%DIF < %DIF < %DIF < %DIF 218-237c79
%DIF < %DIF < %DIF < %DIF < %DIF 187-202c79
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 156-167c79
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 125-132c79
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 95-98c79
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{accsupp}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{lineno}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{bashful}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{lipsum}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 345-359d82
%DIF < %DIF 310-322d82
%DIF < %DIF < %DIF 275-285d82
%DIF < %DIF < %DIF < %DIF 240-248d82
%DIF < %DIF < %DIF < %DIF < %DIF 205-211d82
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 170-174d82
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 135-137d82
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 101d82
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{xcolor}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 362-391c84
%DIF < %DIF 325-350c84
%DIF < %DIF < %DIF 288-309c84
%DIF < %DIF < %DIF < %DIF 251-268c84
%DIF < %DIF < %DIF < %DIF < %DIF 214-227c84
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 177-186c84
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 140-145c84
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 104-105c84
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% External references (commented)
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% \usepackage{xr}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 394-427c87-88
%DIF < %DIF 353-381c87-88
%DIF < %DIF < %DIF 312-335c87-88
%DIF < %DIF < %DIF < %DIF 271-289c87-88
%DIF < %DIF < %DIF < %DIF < %DIF 230-243c87-88
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 189-197c87-88
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 148-151c87-88
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 108a87-88
...
%% -*- coding: utf-8 -*-
%DIF 461-482c122-123
%DIF < %DIF 415-431c122-123
%DIF < %DIF < %DIF 369-380c122-123
%DIF < %DIF < %DIF < %DIF 323-329c122-123
%DIF < %DIF < %DIF < %DIF < %DIF 277-278c122-123
%DIF < %DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-26 18:18:18 (ywatanabe)"
%DIF < %DIF < %DIF < %DIF < %DIF < %% File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/01_manuscript/src/styles/formatting.tex"
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 503-545c136-140
%DIF < %DIF 448-482c136-140
%DIF < %DIF < %DIF 393-419c136-140
...
%DIF < %DIF 501-505c155
%DIF < %DIF < %DIF 434c155
%DIF < %DIF < %DIF < % Use soul package for better text highlighting with line breaks
%DIF < %DIF < %DIF -------
...
%DIF < %DIF 508-510d158
%DIF < %DIF < %DIF 437d158
%DIF < %DIF < %DIF < % Now \hl from soul package will be used directly for text that needs wrapping
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
%DIF -------
...
%DIF 585-601c159
%DIF < %DIF 512-524c159
%DIF < %DIF < %DIF 439-447c159
%DIF < %DIF < %DIF < %DIF 388-392c182
%DIF < %DIF < %DIF < %DIF < %DIF 337c182
%DIF < %DIF < %DIF < %DIF < %DIF < %% Reference
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 604-621d162
%DIF < %DIF 527-542d162
%DIF < %DIF < %DIF 450-463d162
%DIF < %DIF < %DIF < %DIF 395-406d185
%DIF < %DIF < %DIF < %DIF < %DIF 340-349d185
%DIF < %DIF < %DIF < %DIF < %DIF < 
%DIF < %DIF < %DIF < %DIF < %DIF < %% \let\oldref\ref
%DIF < %DIF < %DIF < %DIF < %DIF < %% \renewcommand{\ref}[1]{%
%DIF < %DIF < %DIF < %DIF < %DIF < %%   \ifnum\getrefnumber{#1}=0
%DIF < %DIF < %DIF < %DIF < %DIF < %%     \sethlcolor{yellow}\hl{??}%
%DIF < %DIF < %DIF < %DIF < %DIF < %%   \else
%DIF < %DIF < %DIF < %DIF < %DIF < %%     \oldref{#1}%
%DIF < %DIF < %DIF < %DIF < %DIF < %%   \fi
%DIF < %DIF < %DIF < %DIF < %DIF < %% }
%DIF < %DIF < %DIF < %DIF < %DIF < 
%DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF -------
...
%DIF 631-665c171-175
%DIF < %DIF 552-578c171-175
%DIF < %DIF < %DIF 473-491c171-175
%DIF < %DIF < %DIF < %DIF 416-426c194-198
%DIF < %DIF < %DIF < %DIF < %DIF 359-361c194-198
%DIF < %DIF < %DIF < %DIF < %DIF < % To add an 'S' prefix to a reference
%DIF < %DIF < %DIF < %DIF < %DIF < \newcommand*\sref[1]{%
%DIF < %DIF < %DIF < %DIF < %DIF <     S\hlref{#1}}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 667-686d177
%DIF < %DIF 580-597d177
%DIF < %DIF < %DIF 493-508d177
%DIF < %DIF < %DIF < %DIF 428-441d200
%DIF < %DIF < %DIF < %DIF < %DIF 363-374d200
%DIF < %DIF < %DIF < %DIF < %DIF < % For 'Supplementary Figure S1'
%DIF < %DIF < %DIF < %DIF < %DIF < \newcommand*\sfref[1]{%
%DIF < %DIF < %DIF < %DIF < %DIF <     Supplementary Figure S\hlref{#1}}
%DIF < %DIF < %DIF < %DIF < %DIF <  
%DIF < %DIF < %DIF < %DIF < %DIF < % For 'Supplementary Table S1'
%DIF < %DIF < %DIF < %DIF < %DIF < \newcommand*\stref[1]{%
%DIF < %DIF < %DIF < %DIF < %DIF <     Supplementary Table S\hlref{#1}}
%DIF < %DIF < %DIF < %DIF < %DIF <  
%DIF < %DIF < %DIF < %DIF < %DIF < % For 'Supplementary Materials S1'
%DIF < %DIF < %DIF < %DIF < %DIF < \newcommand*\smref[1]{%
%DIF < %DIF < %DIF < %DIF < %DIF <     Supplementary Materials S\hlref{#1}}
%DIF < %DIF < %DIF < %DIF < %DIF < 
%DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF -------
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-26 18:18:03 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/01_manuscript/src/styles/bibliography.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  Note Re-compile is required
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF > % ============================================================================
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  %% Numbering Style (sorted and listed)
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  [1, 2, 3, 4]
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF > % ----------------------------------------------------------------------------
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Numbering Style (sorted)
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \bibliographystyle{elsarticle-num}
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  Author Style
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  \bibliographystyle{plainnat}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  use \citet{}
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  Numbering Style (not-sorted) 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  \bibliographystyle{plainnat}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  use \cite{}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF > % ----------------------------------------------------------------------------
