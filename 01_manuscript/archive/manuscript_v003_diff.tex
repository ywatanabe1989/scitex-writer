...
%DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Mon Jan 19 02:33:53 2026
%DIF ADD ./01_manuscript/manuscript.tex                     Mon Jan 19 03:07:50 2026
%DIF 2-9d2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v001_diff.tex   Sat Jan 10 00:35:58 2026
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Mon Jan 19 02:33:27 2026
%DIF < %DIF 2-4d2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Sat Jan 10 00:35:46 2026
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Sat Jan 10 00:35:46 2026
%DIF < %DIF -------
%DIF -------
...
%DIF 12-16c4
%DIF < %DIF 7c4
%DIF < %DIF < % Compiled: 2026-01-10 00:35:46
%DIF < %DIF -------
%DIF < % Compiled: 2026-01-19 02:33:27 %DIF > 
%DIF < %DIF -------
%DIF -------
% Compiled: 2026-01-19 03:07:50 %DIF > 
%DIF -------
...
%DIF < %DIF < %% =============================================================================
%DIF < %DIF < %% Comparison: vunknown → v0
%DIF < %DIF < %% Generated: 2026-01-10 00:35:51
%DIF < %DIF < %% User: Yusuke Watanabe <ywatanabe@scitex.ai>
%DIF < %DIF < %% Document: manuscript
%DIF < %DIF < %% Git commit: 0638a04
...
%DIF < %DIF <     \fancyhead[L]{\small\textit{Diff: vunknown → v0}}
%DIF < %DIF <     \fancyhead[R]{\small\textit{manuscript}}
%DIF < %DIF <     \fancyfoot[L]{\small Generated: 2026-01-10 00:35}
...
%DIF <     \fancyfoot[L]{\small Generated: 2026-01-19 02:33}
...
\fancypagestyle{diffstyle}{
    ...
    \fancyfoot[L]{\small Generated: 2026-01-19 03:08}
...
%DIF < DIF > % Timestamp: "2026-01-19 02:31:14 (ywatanabe)"
%DIF < DIF > % File: "/home/ywatanabe/proj/scitex-writer/01_manuscript/contents/additional_info.tex"
...
%DIF < DIFDELCMD < \hl{funding bodies here}
%DIF < DIFDELCMD < %%%
...
%DIFDELCMD < %%%
\DIFdelend % Template table when no actual tables are present
\begin{table}[htbp]
    \centering
      \caption{\DIFdelbeginFL \textbf{\DIFdelFL{Table 0: Placeholder}}%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Placeholder table demonstrating the table format for this manuscript template}}\DIFaddendFL \\
    \smallskip
    To add tables to your manuscript\DIFdelbeginFL \DIFdelFL{:}%DIFDELCMD < \\
%DIFDELCMD <     %%%
\DIFdelFL{1. Place }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, place }\DIFaddendFL CSV files in \texttt{caption\_and\_media/} with format \texttt{XX\_description.csv}\DIFdelbeginFL %DIFDELCMD < \\
%DIFDELCMD <     %%%
\DIFdelFL{2. Create }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, create }\DIFaddendFL matching caption files \texttt{XX\_description.tex}\DIFdelbeginFL %DIFDELCMD < \\
%DIFDELCMD <     %%%
\DIFdelFL{3. Reference }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, and reference }\DIFaddendFL in text using \texttt{Table\textasciitilde\textbackslash ref\{tab:XX\_description\}}\DIFdelbeginFL %DIFDELCMD < \\
%DIFDELCMD <     \smallskip
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. }\DIFaddendFL Example \DIFdelbeginFL \DIFdelFL{: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{can be seen at }\DIFaddendFL \texttt{01\_seizure\_count.csv} with \texttt{01\_seizure\_count.tex}
    }
...
%DIF < DIFDELCMD < \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/01.jpg}
%DIF < DIFDELCMD <     %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\DIFdelendFL \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/01_example_figure.jpg}
    \DIFdelbeginFL %DIFDELCMD < \DIFaddendFL %%%
\DIFdelendFL \caption{Example figure caption. This is a template showing how to include figures in your manuscript. Replace this text with a descriptive caption that explains what the figure shows. Include panel labels (A, B, C) if using multipanel figures. Explain abbreviations and symbols used in the figure. Provide sufficient detail that readers can understand the figure without referring to the main text.}
...
\begin{figure*}[htbp]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/02.jpg}
%DIF < DIFDELCMD <     %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\DIFdelendFL \includegraphics[width=0.9\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/02_another_example.jpg}
    \DIFdelbeginFL %DIFDELCMD < \DIFaddendFL %%%
\DIFdelendFL \caption{Another example figure. Use this template to add additional figures to your manuscript. Each figure should be placed in a separate .tex file in this directory. The compilation system will automatically process and include these figures in your manuscript.}
