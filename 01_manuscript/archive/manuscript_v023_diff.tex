...
%DIF DEL ./01_manuscript/archive/manuscript_v022_diff.tex   Sat Sep 27 00:06:35 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 00:07:13 2025
%DIF 2-58c2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v021_diff.tex   Sat Sep 27 00:05:16 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 00:06:19 2025
%DIF < %DIF 2-51c2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v020_diff.tex   Fri Sep 26 23:55:50 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 00:05:00 2025
%DIF < %DIF < %DIF 2-44c2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v019_diff.tex   Fri Sep 26 23:54:42 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:55:34 2025
%DIF < %DIF < %DIF < %DIF 2-37c2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v018_diff.tex   Fri Sep 26 23:53:52 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:54:26 2025
%DIF < %DIF < %DIF < %DIF < %DIF 2-30c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v017_diff.tex   Fri Sep 26 23:53:15 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:53:37 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-23c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v016_diff.tex   Fri Sep 26 23:48:31 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:52:58 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-16c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v015_diff.tex   Fri Sep 26 23:13:06 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:48:15 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-9c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/versions/manuscript_v014.tex   Fri Sep 26 22:30:18 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                 Fri Sep 26 23:12:49 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-26 16:57:33 (ywatanabe)"
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-26 23:12:24 (ywatanabe)" %DIF > 
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 67-99c11
%DIF < %DIF 60-88c11
%DIF < %DIF < %DIF 53-77c11
%DIF < %DIF < %DIF < %DIF 46-66c11
%DIF < %DIF < %DIF < %DIF < %DIF 39-55c11
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 32-44c11
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 25-33c11
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 18-22c11
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 11c11
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/columns.tex
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/latex_styles/columns.tex %DIF > 
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 121-153c33
%DIF < %DIF 110-138c33
%DIF < %DIF < %DIF 99-123c33
%DIF < %DIF < %DIF < %DIF 88-108c33
%DIF < %DIF < %DIF < %DIF < %DIF 77-93c33
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 66-78c33
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 55-63c33
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 44-48c33
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 33c33
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/packages.tex
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/latex_styles/packages.tex %DIF > 
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 214-246c94
%DIF < %DIF 199-227c94
%DIF < %DIF < %DIF 184-208c94
%DIF < %DIF < %DIF < %DIF 169-189c94
%DIF < %DIF < %DIF < %DIF < %DIF 154-170c94
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 139-151c94
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 124-132c94
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 109-113c94
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 94c94
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/linker.tex
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/latex_styles/linker.tex %DIF > 
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 272-304c120
%DIF < %DIF 253-281c120
%DIF < %DIF < %DIF 234-258c120
%DIF < %DIF < %DIF < %DIF 215-235c120
%DIF < %DIF < %DIF < %DIF < %DIF 196-212c120
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 177-189c120
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 158-166c120
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 139-143c120
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 120c120
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/formatting.tex
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/latex_styles/formatting.tex %DIF > 
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 405-433c221
%DIF < %DIF 382-406c221
%DIF < %DIF < %DIF 359-379c221
%DIF < %DIF < %DIF < %DIF 336-352c221
%DIF < %DIF < %DIF < %DIF < %DIF 313-325c221
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 290-298c221
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 267-271c221
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 244c221
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < \link[supple-]{../supplementary/main}
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 440-468c228
%DIF < %DIF 413-437c228
%DIF < %DIF < %DIF 386-406c228
%DIF < %DIF < %DIF < %DIF 359-375c228
%DIF < %DIF < %DIF < %DIF < %DIF 332-344c228
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 305-313c228
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 278-282c228
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 251c228
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% ./01_manuscript/src/journal_name.tex
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/highlights.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/title.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/authors.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/graphical_abstract.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/abstract.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/keywords.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/wordcount.tex
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/figure_count.txt} %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdel{figures, }%%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/table_count.txt} %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdel{tables, }%%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/abstract_count.txt} %%%
...
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{figures, }%%%
...
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{tables, }%%%
...
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/imrd_count.txt} %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend \DIFaddbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/introduction.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/methods.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/results.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/discussion.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/data_availability.tex
...
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \bibliography{./01_manuscript/src/bibliography}
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/styles/bibliography.tex
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF > % ./01_manuscript/src/latex_styles/bibliography.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/additional_info.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/tables/compiled/FINAL.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % ./01_manuscript/src/figures/compiled/FINAL.tex
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  Generated by compile_figure_tex_files() on Fri Sep 26 10:30:00 PM AEST 2025
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:12:47 PM AEST 2025
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:48:14 PM AEST 2025
%DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:52:55 PM AEST 2025
%DIF < DIF < DIF < DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:53:34 PM AEST 2025
%DIF < DIF < DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:54:23 PM AEST 2025
%DIF < DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:55:31 PM AEST 2025
%DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Sat Sep 27 12:04:56 AM AEST 2025
%DIF < DIF >  Generated by compile_figure_tex_files() on Sat Sep 27 12:06:16 AM AEST 2025
%DIF >  Generated by compile_figure_tex_files() on Sat Sep 27 12:07:10 AM AEST 2025
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/src/figures/caption_and_media/jpg/Figure_ID_00_template.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
...
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/src/figures/caption_and_media/jpg/Figure_ID_01_workflow.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
