...
%DIF DEL ./01_manuscript/archive/manuscript_v007_diff.tex   Sat Sep 27 20:38:03 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:39:08 2025
%DIF 2-36c2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v006_diff.tex   Sat Sep 27 20:37:23 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:37:48 2025
%DIF < %DIF 2-29c2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v005_diff.tex   Sat Sep 27 19:46:35 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:37:06 2025
%DIF < %DIF < %DIF 2-22c2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v004_diff.tex   Sat Sep 27 19:12:03 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:46:20 2025
%DIF < %DIF < %DIF < %DIF 2-15c2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v003_diff.tex   Sat Sep 27 19:11:00 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:11:47 2025
%DIF < %DIF < %DIF < %DIF < %DIF 2-9d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Sat Sep 27 19:09:36 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:10:44 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-4d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Sat Sep 27 19:09:21 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Sat Sep 27 19:09:21 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-27 14:50:40 (ywatanabe)"
%DIF < %DIF < %DIF < %DIF -------
...
%DIF < DIFDELCMD < \DIFadd{Highlight \#1
%DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIFDELCMD < %%%
...
%DIFDELCMD < \DIFdelend %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Highlight \#2
%DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIFDELCMD < %%%
...
%DIFDELCMD < \DIFdelend %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Highlight \#3
%DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIFDELCMD < %%%
...
%DIFDELCMD < \DIFdelend %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Highlight \#4
%DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIFDELCMD < %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{complex }\DIFdelend %%%
%DIFDELCMD < \DIFdelend %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{comprehensive }\DIFdelend %%%
%DIFDELCMD < \DIFdelend %%%
\DIFdelend characterization across extended timescales remains limited \DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{due to the scarcity }\DIFdelend \DIFaddbegin \DIFadd{availability }\DIFaddend %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{computational constraints}\DIFdelend \DIFaddbegin \DIFadd{high computational requirements in PAC computation}\DIFaddend %%%
...
%DIF < DIFDELCMD < \DIFaddbegin \DIFadd{the combination of the NeuroVista dataset and our }\DIFaddend %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{enables }\DIFdelend \DIFaddbegin \DIFadd{system enables ...
%DIF < DIFDELCMD < }
%DIF < DIFDELCMD < %%%
...
%DIF < DIFDELCMD < \DIFadd{Dataset Characteristics}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{The NeuroVista dataset provided extensive long-term iEEG recordings from 9 patients with drug-resistant focal epilepsy. After excluding the initial 100-day post-implantation period, we analyzed a total of XX patient-years of continuous recording (mean: XX months per patient, range: 6-14 months). Across all patients, we identified and analyzed:
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{The 16-channel electrode arrays provided comprehensive spatial coverage of the seizure onset zones, with an average of XX ± XX channels showing significant PAC modulation during seizure events.
%DIF < DIFDELCMD < }
%DIF < DIFDELCMD < %%%
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Phase-Amplitude Coupling Patterns}%%%
...
%DIF < DIFDELCMD < \DIFadd{Baseline PAC Characteristics}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{During interictal periods (>4 hours from any seizure), we observed stable baseline PAC patterns with the following characteristics:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Pre-ictal PAC Evolution}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Analysis of the 60-minute pre-seizure period revealed progressive changes in PAC:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Ictal PAC Dynamics}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{During seizures, PAC showed dramatic alterations:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Post-ictal Recovery}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Following seizure termination, PAC exhibited gradual normalization:
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Spatial Distribution and Channel Consistency}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Analysis of PAC spatial patterns across the 16-channel arrays revealed:
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Seizure Prediction Performance}%%%
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Classification Accuracy}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Using PAC features extracted from 10-second windows, we trained patient-specific classifiers to discriminate pre-ictal from interictal states:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Pseudo-prospective Evaluation}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Testing on held-out data (post day 200) demonstrated:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Patient-specific Variability}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Performance varied across patients, correlating with:
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Best performing patients (n=3) achieved AUC > 0.XX with sensitivity > XX\% at <XX\% time in warning.
%DIF < DIFDELCMD < }
%DIF < DIFDELCMD < %%%
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Temporal Patterns and Circadian Rhythms}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Long-term PAC analysis revealed multi-scale temporal patterns:
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Comparison with Traditional Features}%%%
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{PAC-based prediction outperformed conventional EEG features:
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Combined models incorporating PAC with traditional features achieved marginal improvement (AUC increase: 0.XX, p = 0.XX).
%DIF < DIFDELCMD < }
%DIF < DIFDELCMD < %%%
...
\section{Discussion}
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{Discussion here.}\DIFdelend \DIFaddbegin 
%DIF < DIFDELCMD < %%%
%DIFDELCMD < \DIFdelend 
%DIFDELCMD < %%%
\DIFdelend 
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{Principal Findings}%%%
...
%DIF < DIFDELCMD < %%%
%DIF < DIF < DIFDELCMD < %%%
%DIF < DIFDELCMD < \DIFdel{The SciTeX framework }\DIFdelend \DIFaddbegin %%%
%DIFDELCMD < \DIFdelend %%%
\DIFdelend \url{https://github.com/ywatanabe1989/neurovista}\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFadd{. GPU-accerelated PAC calculation code is available as a standalone Python package `gpac` at }%%%
...
%DIF < DIFDELCMD < \DIFadd{. The SciTeX Python utilities }\DIFaddend %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{...
...
%DIF < DIF < DIFDELCMD < %%%
\section*{%DIF < DIFDELCMD < \DIFdel{Inclusion and Diversity Statement}%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
%DIF < DIF < DIFAUXCMD
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{Claude Code (provided by Anthropic }\DIFdelend \DIFaddbegin \DIFadd{large language models such as Claude (Anthropic Inc.}\DIFaddend %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{ChatGPT (provided by OpenAI) for enhancing the }\DIFdelend \DIFaddbegin \DIFadd{complementing }\DIFaddend %%%
...
%DIF < DIFDELCMD < \DIFdelbegin \DIFdel{the }\DIFdelend %%%
%DIFDELCMD < \DIFdelend %%%
...
\DIFdelendFL \centering
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_00_template.jpg}
%DIF < DIF < DIFDELCMD <     %%%
%DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIFDELCMD < \DIFdelendFL %%%
...
%DIF < DIFDELCMD < \DIFdelbeginFL \DIFdelFL{00.
...
\begin{figure*}[p]
    ...
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_workflow.jpg}
%DIF < DIF < DIFDELCMD <     %%%
%DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIFDELCMD < \DIFdelendFL %%%
...
\\
\DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \DIFaddFL{Description for figure 01.
%DIF < DIFDELCMD < }%%%
