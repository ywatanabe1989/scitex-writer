...
%DIF DEL ./01_manuscript/archive/manuscript_v016_diff.tex   Fri Sep 26 23:48:31 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:52:58 2025
%DIF 2-16c2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v015_diff.tex   Fri Sep 26 23:13:06 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:48:15 2025
%DIF < %DIF 2-9c2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/versions/manuscript_v014.tex   Fri Sep 26 22:30:18 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                 Fri Sep 26 23:12:49 2025
%DIF < %DIF < %DIF 2c2
%DIF < %DIF < %DIF < %% Timestamp: "2025-09-26 16:57:33 (ywatanabe)"
%DIF < %DIF < %DIF -------
%DIF < %DIF < %% Timestamp: "2025-09-26 23:12:24 (ywatanabe)" %DIF > 
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%DIF < %DIF 18-22c11
%DIF < %DIF < %DIF 11c11
%DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/columns.tex
%DIF < %DIF < %DIF -------
%DIF < %DIF < %% ./01_manuscript/src/latex_styles/columns.tex %DIF > 
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%DIF < %DIF 44-48c33
%DIF < %DIF < %DIF 33c33
%DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/packages.tex
%DIF < %DIF < %DIF -------
%DIF < %DIF < %% ./01_manuscript/src/latex_styles/packages.tex %DIF > 
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%DIF < %DIF 109-113c94
%DIF < %DIF < %DIF 94c94
%DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/linker.tex
%DIF < %DIF < %DIF -------
%DIF < %DIF < %% ./01_manuscript/src/latex_styles/linker.tex %DIF > 
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%DIF < %DIF 139-143c120
%DIF < %DIF < %DIF 120c120
%DIF < %DIF < %DIF < %% ./01_manuscript/src/styles/formatting.tex
%DIF < %DIF < %DIF -------
%DIF < %DIF < %% ./01_manuscript/src/latex_styles/formatting.tex %DIF > 
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%DIF 267-271c221
%DIF < %DIF 244c221
%DIF < %DIF < \link[supple-]{../supplementary/main}
%DIF < %DIF -------
...
%DIF 278-282c228
%DIF < %DIF 251c228
%DIF < %DIF < %% ./01_manuscript/src/journal_name.tex
%DIF < %DIF -------
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/highlights.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/title.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/authors.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/graphical_abstract.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/abstract.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/keywords.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/wordcount.tex
...
%DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/figure_count.txt} %%%
%DIFDELCMD < \DIFdel{figures, }%%%
%DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/table_count.txt} %%%
%DIFDELCMD < \DIFdel{tables, }%%%
%DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/abstract_count.txt} %%%
%DIFDELCMD < \DIFdelend \DIFaddbegin %%%
\DIFdelend \readwordcount{./01_manuscript/contents/wordcounts/figure_count.txt} \DIFdelbegin %DIFDELCMD < \DIFadd{figures, }%%%
...
\DIFdelend \DIFaddbegin \DIFadd{tables, }\DIFaddend \readwordcount{./01_manuscript/contents/wordcounts/abstract_count.txt} \DIFdelbegin %DIFDELCMD < \DIFaddend %%%
\DIFdelend words for abstract, and \DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/imrd_count.txt} %%%
%DIFDELCMD < \DIFdelend \DIFaddbegin %%%
\DIFdelend \readwordcount{./01_manuscript/contents/wordcounts/imrd_count.txt} \DIFdelbegin %DIFDELCMD < \DIFaddend %%%
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/introduction.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/methods.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/results.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/discussion.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/data_availability.tex
...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \bibliography{./01_manuscript/src/bibliography}
%DIF < DIFDELCMD < %%%
%DIFDELCMD < \DIFdelend \DIFaddbegin %%%
...
%% ========================================
%DIF < DIF < DIF < % ./01_manuscript/src/styles/bibliography.tex
%DIF < DIF < DIF > % ./01_manuscript/src/latex_styles/bibliography.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/additional_info.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/tables/compiled/FINAL.tex
...
%% ========================================
%DIF < DIF < % ./01_manuscript/src/figures/compiled/FINAL.tex
%DIF < DIF > % ./01_manuscript/contents/figures/compiled/FINAL.tex
%DIF > % ./01_manuscript/contents/figures/compiled/FINAL.tex
%% ========================================
%DIF < DIF < DIF <  Generated by compile_figure_tex_files() on Fri Sep 26 10:30:00 PM AEST 2025
%DIF < DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:12:47 PM AEST 2025
%DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:48:14 PM AEST 2025
%DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:52:55 PM AEST 2025
...
%DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/src/figures/caption_and_media/jpg/Figure_ID_00_template.jpg}
%DIF < DIFDELCMD <     %%%
...
\begin{figure*}[p]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/src/figures/caption_and_media/jpg/Figure_ID_01_workflow.jpg}
%DIF < DIFDELCMD <     %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
