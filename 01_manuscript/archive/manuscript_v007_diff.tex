...
%DIF DEL ./01_manuscript/archive/manuscript_v006_diff.tex   Tue Sep 30 18:00:25 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:00:49 2025
%DIF 2-29d2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v005_diff.tex   Tue Sep 30 17:59:44 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 18:00:09 2025
%DIF < %DIF 2-24d2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v004_diff.tex   Tue Sep 30 17:59:03 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:59:29 2025
%DIF < %DIF < %DIF 2-19d2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v003_diff.tex   Tue Sep 30 17:58:20 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:58:46 2025
%DIF < %DIF < %DIF < %DIF 2-14d2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Tue Sep 30 17:41:53 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:58:01 2025
%DIF < %DIF < %DIF < %DIF < %DIF 2-9d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v001_diff.tex   Tue Sep 30 09:26:46 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:41:35 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-4d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Tue Sep 30 09:26:29 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Tue Sep 30 09:26:29 2025
...
%DIF 64-80c36
%DIF < %DIF 59-71c36
%DIF < %DIF < %DIF 54-62c36
%DIF < %DIF < %DIF < %DIF 49-53c36
%DIF < %DIF < %DIF < %DIF < %DIF 44c36
%DIF < %DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-27 16:01:16 (ywatanabe)"
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 82-100c38-39
%DIF < %DIF 73-86c38-39
%DIF < %DIF < %DIF 64-72c38-39
%DIF < %DIF < %DIF < %DIF 55-58c38-39
%DIF < %DIF < %DIF < %DIF < %DIF 46a38-39
...
%DIF 108-125c47
%DIF < %DIF 94-107c47
%DIF < %DIF < %DIF 80-89c47
%DIF < %DIF < %DIF < %DIF 66-71c47
%DIF < %DIF < %DIF < %DIF < %DIF 53-54c47
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{amsmath, amssymb}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{amsthm}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 132-149c54
%DIF < %DIF 114-127c54
%DIF < %DIF < %DIF 96-105c54
%DIF < %DIF < %DIF < %DIF 78-83c54
%DIF < %DIF < %DIF < %DIF < %DIF 61-62c54
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{pgfplots}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{pgfplotstable}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 154-181c59-60
%DIF < %DIF 132-154c59-60
%DIF < %DIF < %DIF 110-127c59-60
%DIF < %DIF < %DIF < %DIF 88-100c59-60
%DIF < %DIF < %DIF < %DIF < %DIF 67-74c59-60
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{booktabs}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{colortbl}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{longtable}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{supertabular}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{tabularx}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{xltabular}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{csvsimple}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{makecell}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 192-210c71
%DIF < %DIF 165-179c71
%DIF < %DIF < %DIF 138-148c71
%DIF < %DIF < %DIF < %DIF 111-117c71
%DIF < %DIF < %DIF < %DIF < %DIF 85-87c71
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{pdflscape}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{indentfirst}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{calc}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 218-237c79
%DIF < %DIF 187-202c79
%DIF < %DIF < %DIF 156-167c79
%DIF < %DIF < %DIF < %DIF 125-132c79
%DIF < %DIF < %DIF < %DIF < %DIF 95-98c79
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{accsupp}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{lineno}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{bashful}
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{lipsum}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 240-248d82
%DIF < %DIF 205-211d82
%DIF < %DIF < %DIF 170-174d82
%DIF < %DIF < %DIF < %DIF 135-137d82
%DIF < %DIF < %DIF < %DIF < %DIF 101d82
%DIF < %DIF < %DIF < %DIF < %DIF < \usepackage{xcolor}
%DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%DIF 251-268c84
%DIF < %DIF 214-227c84
%DIF < %DIF < %DIF 177-186c84
%DIF < %DIF < %DIF < %DIF 140-145c84
%DIF < %DIF < %DIF < %DIF < %DIF 104-105c84
%DIF < %DIF < %DIF < %DIF < %DIF < %% External references (commented)
%DIF < %DIF < %DIF < %DIF < %DIF < %% \usepackage{xr}
%DIF < %DIF < %DIF < %DIF < %DIF -------
...
%DIF 271-289c87-88
%DIF < %DIF 230-243c87-88
%DIF < %DIF < %DIF 189-197c87-88
%DIF < %DIF < %DIF < %DIF 148-151c87-88
%DIF < %DIF < %DIF < %DIF < %DIF 108a87-88
...
%DIF < %DIF -------
%DIF -------
%% Timestamp: "2025-09-30 17:59:50 (ywatanabe)" %DIF > 
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-26 18:18:03 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/01_manuscript/src/styles/bibliography.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF <  Note Re-compile is required
%DIF < DIF < DIF < DIF < DIF < DIF > % ============================================================================
...
%DIF < DIF < DIF < DIF < DIF < DIF <  %% Numbering Style (sorted and listed)
%DIF < DIF < DIF < DIF < DIF < DIF <  [1, 2, 3, 4]
%DIF < DIF < DIF < DIF < DIF < DIF > % ----------------------------------------------------------------------------
...
%DIF < DIF < DIF < DIF < DIF < DIF < % Numbering Style (sorted)
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \bibliographystyle{elsarticle-num}
...
%DIF < DIF < DIF < DIF < DIF < DIF <  Author Style
%DIF < DIF < DIF < DIF < DIF < DIF <  \bibliographystyle{plainnat}
%DIF < DIF < DIF < DIF < DIF < DIF <  use \citet{}
...
%DIF < DIF < DIF < DIF < DIF < DIF <  Numbering Style (not-sorted) 
%DIF < DIF < DIF < DIF < DIF < DIF <  \bibliographystyle{plainnat}
%DIF < DIF < DIF < DIF < DIF < DIF <  use \cite{}
%DIF < DIF < DIF < DIF < DIF < DIF > % ----------------------------------------------------------------------------
