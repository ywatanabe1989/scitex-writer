...
%DIF DEL ./01_manuscript/archive/manuscript_v006_diff.tex   Sat Sep 27 20:37:23 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:37:48 2025
%DIF 2-29c2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v005_diff.tex   Sat Sep 27 19:46:35 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:37:06 2025
%DIF < %DIF 2-22c2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v004_diff.tex   Sat Sep 27 19:12:03 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:46:20 2025
%DIF < %DIF < %DIF 2-15c2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v003_diff.tex   Sat Sep 27 19:11:00 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:11:47 2025
%DIF < %DIF < %DIF < %DIF 2-9d2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Sat Sep 27 19:09:36 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:10:44 2025
%DIF < %DIF < %DIF < %DIF < %DIF 2-4d2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Sat Sep 27 19:09:21 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Sat Sep 27 19:09:21 2025
%DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %% Timestamp: "2025-09-27 14:50:40 (ywatanabe)"
%DIF < %DIF < %DIF -------
...
\DIFdelbegin %DIFDELCMD < \DIFaddbegin %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFadd{Highlight \#1
%DIFDELCMD < }\DIFaddend 
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \DIFaddbegin %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFadd{Highlight \#2
%DIFDELCMD < }\DIFaddend 
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \DIFaddbegin %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFadd{Highlight \#3
%DIFDELCMD < }\DIFaddend 
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \DIFaddbegin %%%
\DIFdelend \item \DIFdelbegin %DIFDELCMD < \DIFadd{Highlight \#4
%DIFDELCMD < }\DIFaddend 
%DIFDELCMD < %%%
...
Neural oscillations exhibit \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{complex }\DIFdelend %%%
\DIFdelend cross-frequency interactions that are fundamental to brain function and disrupted in neurological disorders. Phase-amplitude coupling (PAC), where the phase of low-frequency oscillations modulates the amplitude of high-frequency activity, serves as a biomarker for various brain states including epileptic seizures. Previous studies have demonstrated PAC changes around seizure events, but \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{comprehensive }\DIFdelend %%%
\DIFdelend characterization across extended timescales remains limited \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{due to the scarcity }\DIFdelend \DIFaddbegin \DIFadd{availability }\DIFaddend %%%
\DIFdelend \DIFaddbegin \DIFadd{availability }\DIFaddend of long-term recording data and \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{computational constraints}\DIFdelend \DIFaddbegin \DIFadd{high computational requirements in PAC computation}\DIFaddend %%%
\DIFdelend \DIFaddbegin \DIFadd{high computational requirements in PAC computation}\DIFaddend . The challenge of processing continuous, long-term neural recordings has hindered the development of reliable seizure prediction systems. Here we show that \DIFdelbegin %DIFDELCMD < \DIFaddbegin \DIFadd{the combination of the NeuroVista dataset and our }\DIFaddend %%%
\DIFdelend \DIFaddbegin \DIFadd{the combination of the NeuroVista dataset and our }\DIFaddend GPU-accelerated PAC computation \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{enables }\DIFdelend \DIFaddbegin \DIFadd{system enables ...
%DIFDELCMD < }
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \DIFaddbegin %%%
\DIFdelend \section{\DIFdelbegin %DIFDELCMD < \DIFadd{Results}%%%
\DIFdelend \DIFaddbegin \DIFadd{Results}\DIFaddend }

\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Dataset Characteristics}%%%
\DIFdelend \DIFaddbegin \DIFadd{Dataset Characteristics}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{The NeuroVista dataset provided extensive long-term iEEG recordings from 9 patients with drug-resistant focal epilepsy. After excluding the initial 100-day post-implantation period, we analyzed a total of XX patient-years of continuous recording (mean: XX months per patient, range: 6-14 months). Across all patients, we identified and analyzed:
...
\DIFdelbegin %DIFDELCMD < \DIFadd{The 16-channel electrode arrays provided comprehensive spatial coverage of the seizure onset zones, with an average of XX ± XX channels showing significant PAC modulation during seizure events.
%DIFDELCMD < }
%DIFDELCMD < %%%
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Phase-Amplitude Coupling Patterns}%%%
\DIFdelend \DIFaddbegin \DIFadd{Phase-Amplitude Coupling Patterns}\DIFaddend }

\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Baseline PAC Characteristics}%%%
\DIFdelend \DIFaddbegin \DIFadd{Baseline PAC Characteristics}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{During interictal periods (>4 hours from any seizure), we observed stable baseline PAC patterns with the following characteristics:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Pre-ictal PAC Evolution}%%%
\DIFdelend \DIFaddbegin \DIFadd{Pre-ictal PAC Evolution}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{Analysis of the 60-minute pre-seizure period revealed progressive changes in PAC:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Ictal PAC Dynamics}%%%
\DIFdelend \DIFaddbegin \DIFadd{Ictal PAC Dynamics}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{During seizures, PAC showed dramatic alterations:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Post-ictal Recovery}%%%
\DIFdelend \DIFaddbegin \DIFadd{Post-ictal Recovery}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{Following seizure termination, PAC exhibited gradual normalization:
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Spatial Distribution and Channel Consistency}%%%
\DIFdelend \DIFaddbegin \DIFadd{Spatial Distribution and Channel Consistency}\DIFaddend }

\DIFdelbegin %DIFDELCMD < \DIFadd{Analysis of PAC spatial patterns across the 16-channel arrays revealed:
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Seizure Prediction Performance}%%%
\DIFdelend \DIFaddbegin \DIFadd{Seizure Prediction Performance}\DIFaddend }

\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Classification Accuracy}%%%
\DIFdelend \DIFaddbegin \DIFadd{Classification Accuracy}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{Using PAC features extracted from 10-second windows, we trained patient-specific classifiers to discriminate pre-ictal from interictal states:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Pseudo-prospective Evaluation}%%%
\DIFdelend \DIFaddbegin \DIFadd{Pseudo-prospective Evaluation}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{Testing on held-out data (post day 200) demonstrated:
...
\subsubsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Patient-specific Variability}%%%
\DIFdelend \DIFaddbegin \DIFadd{Patient-specific Variability}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \DIFadd{Performance varied across patients, correlating with:
...
\DIFdelbegin %DIFDELCMD < \DIFadd{Best performing patients (n=3) achieved AUC > 0.XX with sensitivity > XX\% at <XX\% time in warning.
%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{Best performing patients (n=3) achieved AUC > 0.XX with sensitivity > XX\% at <XX\% time in warning.
}\DIFaddend 

\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Temporal Patterns and Circadian Rhythms}%%%
\DIFdelend \DIFaddbegin \DIFadd{Temporal Patterns and Circadian Rhythms}\DIFaddend }

\DIFdelbegin %DIFDELCMD < \DIFadd{Long-term PAC analysis revealed multi-scale temporal patterns:
...
\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Comparison with Traditional Features}%%%
\DIFdelend \DIFaddbegin \DIFadd{Comparison with Traditional Features}\DIFaddend }

\DIFdelbegin %DIFDELCMD < \DIFadd{PAC-based prediction outperformed conventional EEG features:
...
\DIFdelbegin %DIFDELCMD < \DIFadd{Combined models incorporating PAC with traditional features achieved marginal improvement (AUC increase: 0.XX, p = 0.XX).
%DIFDELCMD < }
%DIFDELCMD < %%%
...
\section{Discussion}
\DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{Discussion here.}\DIFdelend \DIFaddbegin 
%DIFDELCMD < %%%
\DIFdelend 

\subsection{\DIFdelbegin %DIFDELCMD < \DIFadd{Principal Findings}%%%
...
%DIFDELCMD < %%%
%DIF < DIFDELCMD < %%%
%DIFDELCMD < \DIFdel{The SciTeX framework }\DIFdelend \DIFaddbegin %%%
\DIFdelend \url{https://github.com/ywatanabe1989/neurovista}\DIFdelbegin %DIFDELCMD < \DIFadd{. GPU-accerelated PAC calculation code is available as a standalone Python package `gpac` at }%%%
\DIFdelend \DIFaddbegin \DIFadd{. GPU-accerelated PAC calculation code is available as a standalone Python package `gpac` at }\DIFaddend \url{https://github.com/ywatanabe1989/gPAC}\DIFdelbegin %DIFDELCMD < \DIFadd{. The SciTeX Python utilities }\DIFaddend %%%
...
This research was funded by \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{...
...
%DIF < DIFDELCMD < %%%
\section*{%DIFDELCMD < \DIFdel{Inclusion and Diversity Statement}%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
%DIFDELCMD < \DIFdel{We support inclusive, diverse, and equitable conduct of research.
%DIFDELCMD < }%%%
...
The authors employed \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{Claude Code (provided by Anthropic }\DIFdelend \DIFaddbegin \DIFadd{large language models such as Claude (Anthropic Inc.}\DIFaddend %%%
\DIFdelend \DIFaddbegin \DIFadd{large language models such as Claude (Anthropic Inc.}\DIFaddend ) for code development and \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{ChatGPT (provided by OpenAI) for enhancing the }\DIFdelend \DIFaddbegin \DIFadd{complementing }\DIFaddend %%%
\DIFdelend \DIFaddbegin \DIFadd{complementing }\DIFaddend manuscript's English language quality. After incorporating \DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{the }\DIFdelend %%%
...
\DIFdelendFL \centering
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_00_template.jpg}
%DIF < DIFDELCMD <     %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\DIFdelendFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_a.jpg}
    \DIFdelbeginFL %DIFDELCMD < \DIFaddendFL %%%
\DIFdelendFL \caption{
\DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
...
\\
Description for figure \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL \DIFdelFL{00.
%DIFDELCMD < }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{01.
%DIFDELCMD < }\DIFaddendFL %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{01.
}\DIFaddendFL }
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \label{fig:00_template}
%DIF < DIFDELCMD < %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\DIFdelendFL \label{fig:01_demographic_data_a}
\DIFdelbeginFL %DIFDELCMD < \DIFaddendFL %%%
...
\begin{figure*}[p]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_workflow.jpg}
%DIF < DIFDELCMD <     %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\DIFdelendFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_b.jpg}
    \DIFdelbeginFL %DIFDELCMD < \DIFaddendFL %%%
\DIFdelendFL \caption{
\textbf{
Figure 01
...
%DIF < DIFDELCMD < %%%
%DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\DIFdelendFL \label{fig:01_demographic_data_b}
\end{figure*}
...
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01}{figure_id_01}
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_c.jpg}
    \caption{
...
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Description for figure 01.
    ...
    \label{fig:01_demographic_data_c}
\end{figure*}
...
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01}{figure_id_01}
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_d.jpg}
    \caption{
\DIFdelbeginFL \textbf{%DIFDELCMD < \DIFaddFL{Figure 01
%DIFDELCMD < }%%%
}
...
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Description for figure 01.
    ...
    \label{fig:01_demographic_data_d}
\DIFdelbeginFL %DIFDELCMD < \DIFaddendFL %%%
\DIFdelendFL \end{figure*}
