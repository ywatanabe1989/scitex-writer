...
\begin{figure*}[p]
    ...
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_a.jpg}
    \caption{
\textbf{
Figure 01
}
...
Description for figure 01.
    ...
    \label{fig:01_demographic_data_a}
\end{figure*}
...
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01}{figure_id_01}
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_b.jpg}
    \caption{
\textbf{
Figure 01
}
...
Description for figure 01.
    ...
    \label{fig:01_demographic_data_b}
\end{figure*}
