...
%DIF DEL ./01_manuscript/archive/manuscript_v004_diff.tex   Tue Sep 30 17:59:03 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:59:29 2025
%DIF 2-19d2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v003_diff.tex   Tue Sep 30 17:58:20 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:58:46 2025
%DIF < %DIF 2-14d2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Tue Sep 30 17:41:53 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:58:01 2025
%DIF < %DIF < %DIF 2-9d2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v001_diff.tex   Tue Sep 30 09:26:46 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Tue Sep 30 17:41:35 2025
%DIF < %DIF < %DIF < %DIF 2-4d2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Tue Sep 30 09:26:29 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Tue Sep 30 09:26:29 2025
%DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
%DIF -------
...
%DIF < %DIF 49-53c36
%DIF < %DIF < %DIF 44c36
%DIF < %DIF < %DIF < %% Timestamp: "2025-09-27 16:01:16 (ywatanabe)"
%DIF < %DIF < %DIF -------
...
%DIF 80-89c47
%DIF < %DIF 66-71c47
%DIF < %DIF < %DIF 53-54c47
%DIF < %DIF < %DIF < \usepackage{amsmath, amssymb}
%DIF < %DIF < %DIF < \usepackage{amsthm}
%DIF < %DIF < %DIF -------
...
%DIF 110-127c59-60
%DIF < %DIF 88-100c59-60
%DIF < %DIF < %DIF 67-74c59-60
%DIF < %DIF < %DIF < \usepackage{booktabs}
%DIF < %DIF < %DIF < \usepackage{colortbl}
...
%DIF 177-186c84
%DIF < %DIF 140-145c84
%DIF < %DIF < %DIF 104-105c84
%DIF < %DIF < %DIF < %% External references (commented)
...
%DIF 189-197c87-88
%DIF < %DIF 148-151c87-88
%DIF < %DIF < %DIF 108a87-88
%DIF < %DIF < %% EOF %DIF > 
%DIF < %DIF <  %DIF > 
%DIF < %DIF < %DIF -------
%DIF < %DIF -------
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < % Timestamp: "2025-09-26 18:18:03 (ywatanabe)"
%DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/01_manuscript/src/styles/bibliography.tex"
...
%DIF < DIF < DIF < DIF <  Note Re-compile is required
%DIF < DIF < DIF < DIF > % ============================================================================
...
%DIF < DIF < DIF < DIF <  %% Numbering Style (sorted and listed)
%DIF < DIF < DIF < DIF <  [1, 2, 3, 4]
%DIF < DIF < DIF < DIF > % ----------------------------------------------------------------------------
...
%DIF < DIF < DIF < DIF < % Numbering Style (sorted)
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \bibliographystyle{elsarticle-num}
...
%DIF < DIF < DIF < DIF <  Author Style
%DIF < DIF < DIF < DIF <  \bibliographystyle{plainnat}
%DIF < DIF < DIF < DIF <  use \citet{}
...
%DIF < DIF < DIF < DIF <  Numbering Style (not-sorted) 
%DIF < DIF < DIF < DIF <  \bibliographystyle{plainnat}
%DIF < DIF < DIF < DIF <  use \cite{}
%DIF < DIF < DIF < DIF > % ----------------------------------------------------------------------------
