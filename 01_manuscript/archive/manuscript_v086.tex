...
\midrule
\multicolumn{3}{c}{\textit{... 36 rows omitted ...}} \\
\midrule
\rowcolor{gray!10}
P15 & seizure & 64 \\
...
\caption{Table 1_seizure_count: Default caption. Please edit ./01_manuscript/contents/tables/caption_and_media/01_seizure_count.tex to customize. \textit{Note: Table truncated to 30 rows from 65 total rows for display purposes.}}
