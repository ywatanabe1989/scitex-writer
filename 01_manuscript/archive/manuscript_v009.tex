%% -*- coding: utf-8 -*-
%% Timestamp: "2025-09-27 19:27:03 (ywatanabe)"
...
% Figure 01a_demographic_data: Figure 01a_demographic_data
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01a_demographic_data}{figure_id_01a_demographic_data}
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01a_demographic_data.jpg}
    \caption{
\textbf{
Figure 01a_demographic_data
}
\smallskip
\\
Description for figure 01a_demographic_data.
}
    \label{fig:01a_demographic_data}
\end{figure*}

% Figure 01b_demographic_data: Figure 01b_demographic_data
\clearpage
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01b_demographic_data}{figure_id_01b_demographic_data}
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01b_demographic_data.jpg}
    \caption{
\textbf{
Figure 01b_demographic_data
}
\smallskip
\\
Description for figure 01b_demographic_data.
}
    \label{fig:01b_demographic_data}
\end{figure*}

% Figure 01c_demographic_data: Figure 01c_demographic_data
\clearpage
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01c_demographic_data}{figure_id_01c_demographic_data}
    \centering
    \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01c_demographic_data.jpg}
    \caption{
\textbf{
Figure 01c_demographic_data
}
\smallskip
\\
Description for figure 01c_demographic_data.
}
    \label{fig:01c_demographic_data}
\end{figure*}

% Figure 01d_demographic_data: Figure 01d_demographic_data
\clearpage
\begin{figure*}[p]
    \pdfbookmark[2]{Figure 01d_demographic_data}{figure_id_01d_demographic_data}
    \centering
    ...
    \caption{
\textbf{
Figure 01d_demographic_data
}
\smallskip
\\
Description for figure 01d_demographic_data.
}
