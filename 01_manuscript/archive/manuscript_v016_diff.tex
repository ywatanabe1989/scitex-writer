...
%DIF DEL ./01_manuscript/archive/manuscript_v015_diff.tex   Fri Sep 26 23:13:06 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Fri Sep 26 23:48:15 2025
%DIF 2-9c2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/versions/manuscript_v014.tex   Fri Sep 26 22:30:18 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                 Fri Sep 26 23:12:49 2025
%DIF < %DIF 2c2
%DIF < %DIF < %% Timestamp: "2025-09-26 16:57:33 (ywatanabe)"
%DIF < %DIF -------
%DIF < %% Timestamp: "2025-09-26 23:12:24 (ywatanabe)" %DIF > 
%DIF < %DIF -------
%DIF -------
...
%DIF 18-22c11
%DIF < %DIF 11c11
%DIF < %DIF < %% ./01_manuscript/src/styles/columns.tex
%DIF < %DIF -------
%DIF < %% ./01_manuscript/src/latex_styles/columns.tex %DIF > 
%DIF < %DIF -------
%DIF -------
...
%DIF 44-48c33
%DIF < %DIF 33c33
%DIF < %DIF < %% ./01_manuscript/src/styles/packages.tex
%DIF < %DIF -------
%DIF < %% ./01_manuscript/src/latex_styles/packages.tex %DIF > 
%DIF < %DIF -------
%DIF -------
...
%DIF 109-113c94
%DIF < %DIF 94c94
%DIF < %DIF < %% ./01_manuscript/src/styles/linker.tex
%DIF < %DIF -------
%DIF < %% ./01_manuscript/src/latex_styles/linker.tex %DIF > 
%DIF < %DIF -------
%DIF -------
...
%DIF 139-143c120
%DIF < %DIF 120c120
%DIF < %DIF < %% ./01_manuscript/src/styles/formatting.tex
%DIF < %DIF -------
%DIF < %% ./01_manuscript/src/latex_styles/formatting.tex %DIF > 
%DIF < %DIF -------
%DIF -------
...
%DIF 244c221
%DIF < \link[supple-]{../supplementary/main}
%DIF -------
...
%% ========================================
%DIF 251c228
%DIF < %% ./01_manuscript/src/journal_name.tex
%DIF -------
...
%% ========================================
%DIF < % ./01_manuscript/src/highlights.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/title.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/authors.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/graphical_abstract.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/abstract.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/keywords.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/wordcount.tex
...
\begin{wordcount}
\DIFdelbegin %DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/figure_count.txt} %%%
\DIFdel{figures, }%DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/table_count.txt} %%%
\DIFdel{tables, }%DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/abstract_count.txt} %%%
\DIFdelend \DIFaddbegin \readwordcount{./01_manuscript/contents/wordcounts/figure_count.txt} \DIFadd{figures, }\readwordcount{./01_manuscript/contents/wordcounts/table_count.txt} \DIFadd{tables, }\readwordcount{./01_manuscript/contents/wordcounts/abstract_count.txt} \DIFaddend words for abstract, and \DIFdelbegin %DIFDELCMD < \readwordcount{./01_manuscript/src/wordcounts/imrd_count.txt} %%%
\DIFdelend \DIFaddbegin \readwordcount{./01_manuscript/contents/wordcounts/imrd_count.txt} \DIFaddend words for main text
\end{wordcount}

%% \begin{*wordcount}
%DIF < % \readwordcount{./01_manuscript/src/wordcounts/figure_count.txt} figures, \readwordcount{./01_manuscript/src/wordcounts/table_count.txt} tables, \readwordcount{./01_manuscript/src/wordcounts/abstract_count.txt} words for abstract, and \readwordcount{./01_manuscript/src/wordcounts/imrd_count.txt} words for main text
...
%% ========================================
%DIF < % ./01_manuscript/src/introduction.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/methods.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/results.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/discussion.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/data_availability.tex
...
\DIFdelbegin %DIFDELCMD < \bibliography{./01_manuscript/src/bibliography}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{./01_manuscript/contents/bibliography}
\DIFaddend 

%% ========================================
%DIF < DIF < % ./01_manuscript/src/styles/bibliography.tex
%DIF < DIF > % ./01_manuscript/src/latex_styles/bibliography.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/additional_info.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/tables/compiled/FINAL.tex
...
%% ========================================
%DIF < % ./01_manuscript/src/figures/compiled/FINAL.tex
%DIF > % ./01_manuscript/contents/figures/compiled/FINAL.tex
%% ========================================
%DIF < DIF <  Generated by compile_figure_tex_files() on Fri Sep 26 10:30:00 PM AEST 2025
%DIF < DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:12:47 PM AEST 2025
%DIF >  Generated by compile_figure_tex_files() on Fri Sep 26 11:48:14 PM AEST 2025
...
\begin{figure*}[p]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/src/figures/caption_and_media/jpg/Figure_ID_00_template.jpg}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg/Figure_ID_00_template.jpg}
    \DIFaddendFL \caption{
\textbf{
Figure 00
}
...
\begin{figure*}[p]
    ...
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/src/figures/caption_and_media/jpg/Figure_ID_01_workflow.jpg}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg/Figure_ID_01_workflow.jpg}
    \DIFaddendFL \caption{
\textbf{
Figure 01
}
