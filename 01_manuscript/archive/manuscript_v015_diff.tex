...
%DIF DEL ./01_manuscript/archive/manuscript_v014_diff.tex   Sat Sep 27 21:07:49 2025
%DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 21:09:42 2025
%DIF 2-85c2
%DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF DEL ./01_manuscript/archive/manuscript_v013_diff.tex   Sat Sep 27 21:04:48 2025
%DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 21:07:31 2025
%DIF < %DIF 2-78c2
%DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v012_diff.tex   Sat Sep 27 21:02:48 2025
%DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 21:04:31 2025
%DIF < %DIF < %DIF 2-71c2
%DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v011_diff.tex   Sat Sep 27 20:59:03 2025
%DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 21:02:31 2025
%DIF < %DIF < %DIF < %DIF 2-64c2
%DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v010_diff.tex   Sat Sep 27 20:55:12 2025
%DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:58:46 2025
%DIF < %DIF < %DIF < %DIF < %DIF 2-57c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v009_diff.tex   Sat Sep 27 20:51:12 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:54:54 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-50c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v008_diff.tex   Sat Sep 27 20:39:24 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:50:53 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-43c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v007_diff.tex   Sat Sep 27 20:38:03 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:39:08 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-36c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v006_diff.tex   Sat Sep 27 20:37:23 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:37:48 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-29c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v005_diff.tex   Sat Sep 27 19:46:35 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 20:37:06 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-22c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v004_diff.tex   Sat Sep 27 19:12:03 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:46:20 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF 2-15c2
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF LATEXDIFF DIFFERENCE FILE
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v003_diff.tex   Sat Sep 27 19:11:00 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:11:47 2025
...
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/archive/manuscript_v002_diff.tex   Sat Sep 27 19:09:36 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex                     Sat Sep 27 19:10:44 2025
...
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF DEL ./01_manuscript/manuscript.tex   Sat Sep 27 19:09:21 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF ADD ./01_manuscript/manuscript.tex   Sat Sep 27 19:09:21 2025
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF -------
%DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %DIF < %% Timestamp: "2025-09-27 14:50:40 (ywatanabe)"
...
%% ========================================
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \begin{highlights}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \pdfbookmark[1]{Highlights}{highlights}
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \item Highlight \#1
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Highlight \#1
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \item Highlight \#2
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Highlight \#2
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \item Highlight \#3
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Highlight \#3
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \item Highlight \#4
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Highlight \#4
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddend 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \end{highlights}
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-22 07:46:14 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/manuscript/src/abstract.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{complex }\DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{comprehensive }\DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{due to the scarcity }\DIFdelend \DIFaddbegin \DIFadd{availability }\DIFaddend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{computational constraints}\DIFdelend \DIFaddbegin \DIFadd{high computational requirements in PAC computation}\DIFaddend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddbegin \DIFadd{the combination of the NeuroVista dataset and our }\DIFaddend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{enables }\DIFdelend \DIFaddbegin \DIFadd{system enables ...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-22 08:12:53 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/manuscript/src/results.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Results}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Dataset Characteristics}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{The 16-channel electrode arrays provided comprehensive spatial coverage of the seizure onset zones, with an average of XX ± XX channels showing significant PAC modulation during seizure events.
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Phase-Amplitude Coupling Patterns}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Baseline PAC Characteristics}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{During interictal periods (>4 hours from any seizure), we observed stable baseline PAC patterns with the following characteristics:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Pre-ictal PAC Evolution}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Analysis of the 60-minute pre-seizure period revealed progressive changes in PAC:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Ictal PAC Dynamics}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{During seizures, PAC showed dramatic alterations:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Post-ictal Recovery}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Following seizure termination, PAC exhibited gradual normalization:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Spatial Distribution and Channel Consistency}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Analysis of PAC spatial patterns across the 16-channel arrays revealed:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Seizure Prediction Performance}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Classification Accuracy}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Using PAC features extracted from 10-second windows, we trained patient-specific classifiers to discriminate pre-ictal from interictal states:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Pseudo-prospective Evaluation}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Testing on held-out data (post day 200) demonstrated:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Patient-specific Variability}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Performance varied across patients, correlating with:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Best performing patients (n=3) achieved AUC > 0.XX with sensitivity > XX\% at <XX\% time in warning.
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Temporal Patterns and Circadian Rhythms}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Long-term PAC analysis revealed multi-scale temporal patterns:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Comparison with Traditional Features}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{PAC-based prediction outperformed conventional EEG features:
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Combined models incorporating PAC with traditional features achieved marginal improvement (AUC increase: 0.XX, p = 0.XX).
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-26 18:19:43 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/01_manuscript/src/discussion.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{Discussion here.}\DIFdelend \DIFaddbegin 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend 
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{Principal Findings}%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{...
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-19 10:34:25 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/manuscript/src/data_availability_revised.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \url{https://github.com/ywatanabe1989/neurovista-pac} %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdel{(to be made public upon publication). The repository includes:
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < - PAC computation pipeline (PyTorch implementation)
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < - Database management utilities (SQLite3)
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < - Visualization scripts for comodulograms and temporal analysis
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < - Statistical analysis and seizure prediction algorithms
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < - Jupyter notebooks reproducing all figures and results
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdel{The SciTeX framework }\DIFdelend \DIFaddbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{. GPU-accerelated PAC calculation code is available as a standalone Python package `gpac` at }%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFadd{. The SciTeX Python utilities }\DIFaddend %%%
...
%% ========================================
%% -*- coding: utf-8 -*-
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % Timestamp: "2025-09-22 08:08:53 (ywatanabe)"
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % File: "/ssh:sp:/home/ywatanabe/proj/neurovista/paper/manuscript/src/additional_info.tex"
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFdelend \DIFaddbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \pdfbookmark[2]{Inclusion and Diversity Statement}{inclusion_and_diversity_statement}        
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
\section*{%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdel{Inclusion and Diversity Statement}%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
%DIF < DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdel{We support inclusive, diverse, and equitable conduct of research.
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \label{inclusion and diversity statement}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{Claude Code (provided by Anthropic }\DIFdelend \DIFaddbegin \DIFadd{large language models such as Claude (Anthropic Inc.}\DIFaddend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{ChatGPT (provided by OpenAI) for enhancing the }\DIFdelend \DIFaddbegin \DIFadd{complementing }\DIFaddend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin \DIFdel{the }\DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelend %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \pdfbookmark[2]{Appendices}{appendices}                    
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \appendix
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \section{}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < % \label{}
\DIFdelbegin %DIFDELCMD < \DIFdelbegin %%%
%DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelbegin %%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF <  Figure 00: Figure 00
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01a_demographic_data: Figure 01a_demographic_data
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \pdfbookmark[2]{Figure 00}{figure_id_00}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \pdfbookmark[2]{Figure 01}{figure_id_01}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \pdfbookmark[2]{Figure 01a_demographic_data}{figure_id_01a_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFaddendFL \centering
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_00_template.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_a.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01a_demographic_data.jpg}
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
\textbf{%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelFL{Figure 00
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
...
\textbf{%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddFL{Figure 01a_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \\
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelFL{Description for figure }%%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL \DIFdelFL{00.
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \DIFaddFL{01.
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \DIFaddFL{01a_demographic_data.
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \label{fig:00_template}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \label{fig:01_demographic_data_a}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \label{fig:01a_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL \end{figure*}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIFDELCMD < 
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01b_demographic_data: Figure 01b_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \clearpage
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \begin{figure*}[p]
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \pdfbookmark[2]{Figure 01}{figure_id_01}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \pdfbookmark[2]{Figure 01b_demographic_data}{figure_id_01b_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFaddendFL \centering
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_workflow.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_b.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01b_demographic_data.jpg}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \caption{%
%DIF < DIF < DIF < DIF < DIFDELCMD < {%%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
\textbf{%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelFL{Figure 01
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\textbf{%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddFL{Figure 01b_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelFL{Description for figure }%%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL \DIFdelFL{01.
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{01b_demographic_data.
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \label{fig:01_workflow}
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \label{fig:01_demographic_data_b}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \label{fig:01b_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL \end{figure*}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIFDELCMD < 
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01: Figure 01
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01: Figure 01
%DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01c_demographic_data: Figure 01c_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \clearpage
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \begin{figure*}[p]
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \pdfbookmark[2]{Figure 01}{figure_id_01}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \pdfbookmark[2]{Figure 01c_demographic_data}{figure_id_01c_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFaddendFL \centering
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_c.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01c_demographic_data.jpg}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \caption{%
%DIF < DIF < DIF < DIF < DIFDELCMD < {%%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
\textbf{%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddFL{Figure 01c_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddFL{Description for figure 01.
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \DIFaddFL{Description for figure 01c_demographic_data.
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }\DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \label{fig:01_demographic_data_c}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL \label{fig:01c_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL \end{figure*}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIFDELCMD < 
...
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01: Figure 01
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01: Figure 01
%DIF < DIF < DIF < DIF < DIF < DIF < DIF >  Figure 01d_demographic_data: Figure 01d_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \clearpage
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \begin{figure*}[p]
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \DIFaddbeginFL \pdfbookmark[2]{Figure 01d_demographic_data}{figure_id_01d_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \centering
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01d_demographic_data.jpg}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \caption{%
%DIF < DIF < DIF < DIF < DIFDELCMD < {%%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
\textbf{%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddFL{Figure 01d_demographic_data
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
}
%DIFAUXCMD
%DIF < DIFAUXCMD
...
%DIF < DIF < DIF < DIF < DIFAUXCMD
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \smallskip
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \\
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddFL{Description for figure 01d_demographic_data.
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < }%%%
%DIF < DIF < DIF < DIF < DIFDELCMD < }
%DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFAUXCMD
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \label{fig:01d_demographic_data}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \end{figure*}
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIF < DIFDELCMD < 
%DIF < DIF < DIFDELCMD < 
...
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \includegraphics[width=0.95\textwidth]{./01_manuscript/contents/figures/caption_and_media/jpg_for_compilation/Figure_ID_01_demographic_data_d.jpg}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD <     %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL \DIFaddbeginFL %%%
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
%DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
...
%DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \label{fig:01_demographic_data_d}
%DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelbeginFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFaddendFL %%%
%DIF < DIF < DIF < DIF < DIF < DIF < DIF < DIFDELCMD < \DIFdelendFL %%%
