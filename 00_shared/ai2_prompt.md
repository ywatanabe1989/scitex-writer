...
- `Alessandri2024CREDOAFA`
- `Ariamajd2025PyPackITARA`
- `Balk2024AFAA`
- `Bar2020ReproducibleSWA`
- `Barba2018PraxisORA`
- `Bizopoulos2020AMFA`
- `Braga2023NotJFA`
- `Brinckman2018ComputingEFA`
- `Canesche2023PreparingRSA`
- `Chen2024GitHubIAA`
- `ClyburneSherin2019ComputationalRVA`
- `Costa2025AFFA`
- `Dasgupta2025AnOFA`
- `Espinosa2020ACIA`
- `GimnezAlventosa2020APRICOTAPA`
- `Himmelstein2019OpenCWA`
- `Jacobs2020ImprovingTRA`
- `Konkol2020PublishingCRA`
- `Krewinkel2017FormattingOSA`
- `Krieger2019FacilitatingRPA`
- `Li2025BuildYPA`
- `Mang2023ReproducibilityI2A`
- `Nst2020TheRPA`
- `Peikert2021ReproducibleRIA`
- `Piccolo2021SimplifyingTDA`
- `Ram2013GitCFA`
- `Saraiva2025RxivMakerAAA`
- `Savonen2022OpensourceTFA`
- `Schulz2018ReproducibleDCA`
- `Stanisic2015AnEGA`
- `Tie2025ASOA`
- `Wiebels2021LeveragingCFA`
- `YourName2021_Conference`
- `YourName2023_NovelMethod_duplicate`