...
- Return revisions in code block format: ``` tex YOUR REVISION ```
...
Provide your abstract draft text for revision. The revision will be returned in a LaTeX code block.
