---
description: |
  [TOPIC] Scientific Introduction Writing Guidelines
  [DETAILS] Introduction writing guidelines — role, aim, style/volume/miscellaneous rules, and 8-section introduction template for scientific manuscripts..
tags: [scitex-writer-writing-introduction]
---
...
- Insert a newline with tab indentation between paragraphs, except for between the first and second paragraphs; both [1. Opening Statement] and [2. Importance of the Field] sections should be in the first paragraph
...
Describe the approach and methods used in your research, in one paragraph. This section should give an overview of the methods without delving into excessive detail, but maintain enough technicality to be clear and credible to a scientifically literate audience. Also, highlight the superiority of current study over existing works mentioned in the [4. Limitations in Previous Works].
...
- [34_writing-introduction-example.md](34_writing-introduction-example.md) — section tags, annotated example, and usage
