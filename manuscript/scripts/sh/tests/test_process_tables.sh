...
EOF
    ...
    cp "${MODULES_DIR}/process_tables.sh" "${TEST_TMP_DIR}/scripts/sh/modules/process_tables_test.sh"
...
EOF
    ...
    sed -i "s|source \./scripts/sh/modules/config.sh|source ${TEST_TMP_DIR}/scripts/sh/modules/config.sh|g" "${TEST_TMP_DIR}/scripts/sh/modules/process_tables_test.sh"
}
...
run_tests() {
    ...
    cd "${TEST_TMP_DIR}"
    source "${TEST_TMP_DIR}/scripts/sh/modules/process_tables_test.sh"
