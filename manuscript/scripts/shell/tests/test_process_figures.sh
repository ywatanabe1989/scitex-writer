...
EOF
    ...
    sed -i "s|source \./scripts/shell/modules/config.sh|source ${TEST_TMP_DIR}/scripts/shell/modules/config.sh|g" "${TEST_TMP_DIR}/scripts/shell/modules/process_figures_test.sh"
}
