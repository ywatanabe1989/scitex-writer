...
%DIF DEL ./02_supplementary/archive/supplementary_v010.tex   Wed Nov 12 10:31:27 2025
%DIF ADD ./02_supplementary/supplementary.tex                Wed Nov 12 11:07:52 2025
% ============================================================================== %DIF > 
% SciTeX Writer v2.0.0-rc2 (https://scitex.ai) %DIF > 
% LaTeX compilation engine: latexmk %DIF > 
% Compiled: 2025-11-12 11:07:52 %DIF > 
% ============================================================================== %DIF > 
 %DIF > 
%DIF -------
%% -*- coding: utf-8 -*-
...
%% Document features
%DIF 84c90
%DIF < % % \usepackage{accsupp, lineno, bashful, lipsum}  % Disabled for tectonic  % Disabled for tectonic
%DIF -------
...
\linespread{1.2}
%DIF 110c116
%DIF < % \linenumbers  % Disabled for tectonic
%DIF -------
\linenumbers %DIF > 
%DIF -------
...
\begin{wordcount}
\DIFdelbegin \DIFdel{0 }\DIFdelend \DIFaddbegin \readwordcount{./02_supplementary/contents/wordcounts/figure_count.txt} \DIFaddend supplementary figures, \DIFdelbegin \DIFdel{0 }\DIFdelend \DIFaddbegin \readwordcount{./02_supplementary/contents/wordcounts/table_count.txt} \DIFaddend supplementary tables, \DIFdelbegin \DIFdel{1077 }\DIFdelend \DIFaddbegin \readwordcount{./02_supplementary/contents/wordcounts/imrd_count.txt} \DIFaddend words for supplementary text
\end{wordcount}

%% \begin{*wordcount}
%DIF < % 0 supplementary figures, 0 supplementary tables, 1077 words for supplementary text
...
% ======================================================================
% File: ./02_supplementary/contents/tables/compiled/00_Tables_Header.tex
% ======================================================================
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TABLES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
