...
# (project=scitex-writer, owner=ywatanabe1989, repo=scitex-writer,
...
TMPDIR="/tmp/publish-scitex_writer-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-writer dist/* uploaded to PyPI via manual OIDC trusted publishing"
