...
setup_test_env() {
    ...
    cat > "${TEST_TMP_DIR}/contents/tables/contents/Table_ID_01_test.csv" << EOF
...
EOF
    ...
    cat > "${TEST_TMP_DIR}/contents/tables/contents/Table_ID_01_test.tex" << EOF
\caption{
...
EOF
    ...
    cat > "${TEST_TMP_DIR}/contents/tables/contents/_Table_ID_XX.tex" << EOF
\caption{
\textbf{TITLE HERE.}
\smallskip
\\
