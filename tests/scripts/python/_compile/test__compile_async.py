"""Auto-generated smoke test for scitex_writer.scripts.python._compile._compile_async.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex_writer.scripts.python._compile._compile_async')
    except ImportError as e:
        pytest.skip(f"scitex_writer.scripts.python._compile._compile_async: {e}")
